...
func ResponseInputItemMcpListToolsParamFromResponseOutputItemMcpListTools(
	...
	return responses.ResponseInputItemMcpListToolsParam{
		...
		Tools:       ResponseInputItemMcpListToolsToolParamSliceFromResponseInputItemMcpListToolsToolParamSlice(input.Tools),
		Error:       makeOpt(input.Error),
		Type:        constant.ValueOf[constant.McpListTools](),
	}
}
func ResponseInputItemMcpListToolsToolParamSliceFromResponseInputItemMcpListToolsToolParamSlice(
	...
	for i, item := range input {
		out[i] = ResponseInputItemMcpListToolsToolParamFromResponseInputItemMcpListToolsToolParam(item)
	}
	return out
}

func ResponseInputItemMcpListToolsToolParamFromResponseInputItemMcpListToolsToolParam(
	input responses.ResponseOutputItemMcpListToolsTool,
) responses.ResponseInputItemMcpListToolsToolParam {
