...
func (m *FakeModel) GetResponse(ctx context.Context, params agents.ModelGetResponseParams) (*agents.ModelResponse, error) {
...
func (m *FakeModel) StreamResponse(ctx context.Context, params agents.ModelStreamResponseParams) (iter.Seq2[*agents.TResponseStreamEvent, error], error) {
	m.LastTurnArgs = FakeModelLastTurnArgs{
		SystemInstructions: params.SystemInstructions,
		Input:              params.Input,
		ModelSettings:      params.ModelSettings,
